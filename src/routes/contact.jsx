      ...
      <Section className="relative bg-circuit">
        ...
        <div className="grid lg:grid-cols-2 gap-10 relative">
          <div className="space-y-4">
            <a href="mailto:hello@meroviq.com" className="flex items-center gap-3 p-5 rounded-2xl border border-hairline bg-white/95 backdrop-blur-sm hover:border-brand/30 hover:shadow-soft transition-all duration-300">
            ...
            <a href="tel:+910000000000" className="flex items-center gap-3 p-5 rounded-2xl border border-hairline bg-white/95 backdrop-blur-sm hover:border-brand/30 hover:shadow-soft transition-all duration-300">
            ...
            <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="flex items-center gap-3 p-5 rounded-2xl border border-hairline bg-white/95 backdrop-blur-sm hover:border-brand/30 hover:shadow-soft transition-all duration-300">
